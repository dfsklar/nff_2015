...
(function() {
  ...
  window.nfforg.MAPenumToEnglish = {
    ...
    action_staff: {
      ...
      ".10": "Give COLA (Cost of Living Adjustment) salary increases",
      ".11": "Give raises beyond COLA",
    ...
    action_staff_for_trend_charts: {
        ...
        "gave_raises": "Give raises beyond COLA",
    ...
    action_ops_finance_for_trend_charts: {
